...
public final class IntakeConstants {
  ...
  public static final double THROUGH_BORE_ENCODER_OFFSET_RAD = -0.25;

  public static final Angle STOW_ANGLE = Degrees.of(107.0);
  ...
  public static final double PIVOT_kP = 5.9;
