...
public class Shooter extends SubsystemBase {
  ...
  private void setupMotor(){
    ...
    shooterMotorConfig.CurrentLimits.SupplyCurrentLowerTime = 0; //needs to be a value, not sure if SupplyCurrentLowerTime is correct
  ...
  public boolean isReady(){
    boolean isReady = Math.abs(toRPM(shooter.getClosedLoopError().getValueAsDouble())) < 0; //needs value
    return isReady;
  }
